...
[dist,ix,iy]=dtw(NCS_temp,EMG_temp);
figure()
%findpeaks(NCS_temp,fsDS,'MinPeakProminence',1,'Annotate','extents')
findpeaks(NCS_temp,fsDS,'MinPeakHeight',1,'Annotate','extents')
[p1,loc1,wid1,pro1]=findpeaks(NCS_temp,fsDS,'MinPeakProminence',1,'Annotate','extents');
hold on
findpeaks(EMG_temp,fsDS,'MinPeakProminence',1,'Annotate','extents')
[p2,loc2,wid2,pro2]=findpeaks(EMG_temp,fsDS,'MinPeakProminence',1,'Annotate','extents');
